...
function renderProducts(products) {
  ...
  paginatedItems.forEach(product => {
    ...
    card.innerHTML = `
      <img src="${product.image}" alt="${product.name}" class="rounded-md w-full h-48 object-contain hover:transform hover:brightness-75 transition-transform duration-300 hover:scale-105" loading="lazy" />
